...
public class TextMng : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        popChapter_ = TextPopPrefab_.GetComponent<PopList>().GetMobList(nowChapterNum_);
        //Debug.Log("総数 = " + popChapter_.param.Count);
        //Debug.Log("0番目 name=" + popChapter_.param[0].name1);
        //Debug.Log("1番目 name=" + popChapter_.param[1].name1);
